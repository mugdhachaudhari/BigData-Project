...
drop table if exists payment_g;

create table payment_g ROW FORMAT DELIMITED 
FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'
LOCATION '${OUTPUT}/payment_g' 
...
from taxi_trips_g where payment_type is not null and payment_type <> '') pay
group by yr) a
order by yr desc;