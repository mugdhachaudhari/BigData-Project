...
drop table if exists ssn_dest_g;

create table ssn_dest_g ROW FORMAT DELIMITED 
FIELDS TERMINATED BY ',' LINES TERMINATED BY '\n'
LOCATION '${OUTPUT}/ssn_dest_g' 
...
ELSE 'Wrong Season' END as season, dropRgn, dropRgnMain from taxi_trips_g where dropRgn <> 'UNKNOWN') ssn
